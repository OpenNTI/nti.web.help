...
export default class Contact extends React.Component {
	...
	static show() {
		return new Promise((fulfill, reject) => {
			Prompt.modal(
				<Contact onSelect={fulfill} onCancel={reject} />,
		...
		return (
			<div className="contact-us">
				<div className="body">
					...
					<p className="info">
						Please use the form below to share your comments, report
						an issue, or suggest new features. If you need help or
						have a question about the features, please take a look
						at the{' '}
						<a
							className="link"
							target="blank"
							href="http://help.nextthought.com"
						>
					...
					{this.state.error && (
						<div className="error-message">
							<span className="err-field">
								{this.state.errorMessage.title}
							</span>
							<span className="err-desc">
								{this.state.errorMessage.desc}
							</span>
						</div>
					)}
					{this.state.success && (
